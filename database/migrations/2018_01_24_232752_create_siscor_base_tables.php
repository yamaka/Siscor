...
class CreateSiscorBaseTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('units', function (Blueprint $table) {
            $table->bigIncrements('id')->unsigned();
            $table->bigIncrements('direction_id')->unsigned();
            $table->bigIncrements('user_created_id')->unsigned()->default(1);
            $table->bigIncrements('user_modified_id')->unsigned()->default(1);
            $table->string('name');
            $table->string('description');
        ...
        Schema::create('positions', function (Blueprint $table) {
            $table->bigIncrements('id')->unsigned();
            $table->bigIncrements('user_created_id')->unsigned();
            $table->bigIncrements('user_modified_id')->unsigned()->nullable();
            $table->string('name');
            $table->string('description');
            $table->foreign('user_created_id')->references('id')->on('users');
            $table->foreign('user_modified_id')->references('id')->on('users');
        ...
        Schema::create('roadmaps', function (Blueprint $table) {
            $table->bigIncrements('id')->unsigned();
            $table->bigIncrements('type_id')->unsigned()->nullable();
            $table->bigIncrements('direction_created_id')->unsigned();
            $table->bigIncrements('unit_created_id')->unsigned();
            $table->bigIncrements('current_sequence_id')->unsigned();
            $table->enum('status', ['finish', 'process','observate'])->default('no');
            ...
            $table->foreign('unit_created_id')->references('id')->on('untis');
        ...
        Schema::create('sequences', function (Blueprint $table) {
            $table->bigIncrements('id')->unsigned();
            $table->bigIncrements('type_id')->unsigned()->nullable();
            $table->bigIncrements('from_position_unit_id')->unsigned();
            $table->bigIncrements('to_position_unit_id')->unsigned();
            $table->bigIncrements('from_user__id')->unsigned();
            $table->bigIncrements('to_user_id')->unsigned();
